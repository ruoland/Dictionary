...
public abstract class DictionaryContent {
    ...
    public DictionaryContent(String id) {
        this.id = id;
    ...
    public void setDictionary(String newDictionary) {
        ...
        Dictionary.LOGGER.info("setDictionary called for {}: old = {}, new = {}", getID(), dictionary, newDictionary);
